package com.akka.samples.quickstart;
...
public class Greeter extends AbstractBehavior<Greeter.Greet> {
    ...
    // Message to send and the reference to the actor to send that message
    ...
    // Message returned and the reference to the actor to return the message
